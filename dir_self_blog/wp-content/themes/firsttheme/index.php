    ...
    <div id="post-<?php the_ID() ?>" class="<?php sandbox_post_class() ?>">
      <div class="post-title">
        ...
        <div class="info"> <span class="date">
          <?php unset($previousday); printf('%1$s', the_date( sprintf(__('%1$s年%2$s月%3$s日'), 'Y', 'm', 'd'), '', '', false )) ?>
          </span> </div>
      </div>
      <!-- .post-title-->
      <div class="entry-content">
        <?php the_content( __( '更多内容 <span class="meta-nav">&raquo;</span>', 'ourws' ) ) ?>
        <?php wp_link_pages('before=<div class="page-link">' . __( '页面:', 'ourws' ) . '&after=</div>') ?>
      </div>
